    ...
    <div className="min-h-screen bg-[#FAF7F4]">
      ...
      <main className="mx-auto max-w-[720px] px-6 pb-20 pt-[72px]">
        ...
        <div className="mb-4 flex items-center gap-4">
          <h1 className="text-[38px] font-medium tracking-[-0.03em] text-[#1A1A1A]">
            Site Blocker
          </h1>
          <a
            href="/site-blocker-extension.zip"
            download
            className="inline-flex items-center gap-1.5 rounded-lg bg-[#C74B6F] px-4 py-2 text-[13px] font-semibold text-white transition-all hover:bg-[#b3405f] hover:shadow-md"
          >
            <svg
              width="14"
              height="14"
